...
def register():
    ...
    if form.validate_on_submit():
        ...
        user.save()
        flash(
            f"Your account have been created! You are now able to login",
            "success",
        )
...
def login():
    ...
    if form.validate_on_submit():
        ...
        if user and user.verify_password(form.password.data):
            ...
            flash(
                f"Login Unsuccessful. Please check email or password", "danger"
            )
    return render_template(template, **context)
...
def save_picture(form_picture):
    ...
    picture_path = os.path.join(
        current_app.root_path, "static/main/profile_pics", picture_fn
    )
...
def account():
    ...
    context["image_file"] = url_for(
        "static", filename="main/profile_pics/" + current_user.image_file
    )
    return render_template(template, **context)
